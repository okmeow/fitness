...
/* harmony import */ var _modules_abonements_tabs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/abonements-tabs.js */ "./js/modules/abonements-tabs.js");
...
/* harmony import */ var _modules_feedback_swiper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/feedback-swiper.js */ "./js/modules/feedback-swiper.js");
/* harmony import */ var _modules_trainers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/trainers.js */ "./js/modules/trainers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_abonements_tabs_js__WEBPACK_IMPORTED_MODULE_2__["abonnementRadioButtonsHandler"])();
  Object(_modules_video_js__WEBPACK_IMPORTED_MODULE_3__["buttonVideoStartHandler"])();
  Object(_modules_feedback_swiper_js__WEBPACK_IMPORTED_MODULE_4__["feedbackHandler"])();
  Object(_modules_trainers_js__WEBPACK_IMPORTED_MODULE_5__["cardsSizeHandler"])();
  Object(_modules_trainers_js__WEBPACK_IMPORTED_MODULE_5__["trainersFocusHandler"])();
...
/***/ "./js/modules/abonements-tabs.js":
/*!***************************************!*\
  !*** ./js/modules/abonements-tabs.js ***!
  \***************************************/
/*! exports provided: abonnementRadioButtonsHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "abonnementRadioButtonsHandler", function() { return abonnementRadioButtonsHandler; });
var Abonnements = {
  MONTH: 0,
  HALF_YEAR: 1,
  YEAR: 2
};
var abonnementRadioButtons = document.querySelectorAll('[data-radio="data-radio"]');
var abonnementRadioButtonsList = document.querySelector('[data-radio-list="data-radio-list"]');
var abonnementListMonthElement = document.querySelector('[data-abonnement="data-abonnement-month"]');
var abonnementListHalfYearElement = document.querySelector('[data-abonnement="data-abonnement-half-year"]');
var abonnementListYearElement = document.querySelector('[data-abonnement="data-abonnement-year"]');
var abonnementRadioButtonsHandler = function abonnementRadioButtonsHandler() {
  ...
  abonnementRadioButtons.forEach(function (abonnementRadioButton) {
    return abonnementRadioButton.addEventListener('click', function () {
...
/***/ "./js/modules/feedback-swiper.js":
/*!***************************************!*\
  !*** ./js/modules/feedback-swiper.js ***!
  \***************************************/
/*! exports provided: feedbackHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "feedbackHandler", function() { return feedbackHandler; });
var feedbackMessages = document.querySelectorAll('[data-feedback-item="data-feedback-item"]');
var feedbackButtonNextElement = document.querySelector('[data-feedback-button-next="data-feedback-button-next"]');
var feedbackButtonPreviousElement = document.querySelector('[data-feedback-button-previous="data-feedback-button-previous"]');
var SWIPE_MIN_DISTANCE = 70;
var END_SWIPE_TIMEOUT = 200;
var startPoint;
var moved = false;
var buttonToggler = function buttonToggler() {
...
var nextSlideOn = function nextSlideOn() {
  for (var i = 0; i < feedbackMessages.length - 1; i++) {
...
var previousSlideOn = function previousSlideOn() {
  for (var i = 1; i < feedbackMessages.length; i++) {
    if (feedbackMessages[i].classList.contains('feedback__item--active')) {
      feedbackMessages[i].classList.remove('feedback__item--active');
      feedbackMessages[i - 1].classList.add('feedback__item--active');
      buttonToggler();
...
var defineTouch = function defineTouch(evt) {
  evt.preventDefault();
  startPoint = evt.changedTouches[0].pageX;
};
var defineMove = function defineMove(evt) {
  if (moved) {
    return;
  }
  evt.preventDefault();
...
var feedbackHandler = function feedbackHandler() {
  feedbackMessages.forEach(function (item) {
    return item.addEventListener('touchmove', defineMove);
  });
  feedbackMessages.forEach(function (item) {
    return item.addEventListener('touchstart', defineTouch);
  });
  feedbackMessages.forEach(function (item) {
    return item.addEventListener('touchend', function () {
      setTimeout(function () {
        moved = !moved;
      }, END_SWIPE_TIMEOUT);
    });
...
/*!********************************!*\
  !*** ./js/modules/trainers.js ***!
  \********************************/
/*! exports provided: cardsSizeHandler, trainersFocusHandler, swiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cardsSizeHandler", function() { return cardsSizeHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "trainersFocusHandler", function() { return trainersFocusHandler; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swiper", function() { return swiper; });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.esm.js");

var WidthHeightCardsConstants = {
  DESKTOP: 1.1307,
  TABLET: 1.097,
  MOBILE: 1.2124
};
...
var trainerCardElements = document.querySelectorAll('[data-trainer-card="data-trainer-card"]');
var trainerCardExtraElements = document.querySelectorAll('[data-trainer-extra="data-trainer-extra"]');
var superGamesButtonElement = document.querySelector('[data-super-games-button="data-super-games-button"]');
var trainerButtonPrevElement = document.querySelector('[data-trainer-button="data-trainer-button"]');
var setCardsSize = function setCardsSize() {
  for (var i = 0; i < trainerCardElements.length; i++) {
...
var cardsSizeHandler = function cardsSizeHandler() {
  setCardsSize();
...
var trainersFocusHandler = function trainersFocusHandler() {
  if (window.innerWidth >= 1200) {
    superGamesButtonElement.addEventListener('keydown', function (evt) {
      if (isTabKey(evt)) {
        evt.preventDefault();
        document.querySelector('.swiper-slide-active').focus();
      }
    });
    trainerCardElements[7].addEventListener('keydown', function (evt) {
      if (isTabKey(evt)) {
        evt.preventDefault();
        trainerButtonPrevElement.focus();
      }
    });
    trainerButtonPrevElement.addEventListener('keydown', function (evt) {
  ...
  if (window.innerWidth <= 1199 && window.innerWidth >= 768) {
    ...
    trainerCardElements[5].addEventListener('keydown', function (evt) {
      if (isTabKey(evt)) {
        evt.preventDefault();
        trainerButtonPrevElement.focus();
      }
  ...
  if (window.innerWidth <= 767) {
    ...
    trainerCardElements[3].addEventListener('keydown', function (evt) {
      if (isTabKey(evt)) {
        evt.preventDefault();
        trainerButtonPrevElement.focus();
      }
...
/*!*****************************!*\
  !*** ./js/modules/video.js ***!
  \*****************************/
/*! exports provided: buttonVideoStartHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "buttonVideoStartHandler", function() { return buttonVideoStartHandler; });
var buttonVideoStart = document.querySelector('[data-video-button="data-video-button"]');
var video = document.querySelector('[data-video="data-video"]');
var videoCover = document.querySelector('[data-preview-video="data-preview-video"]');
var buttonVideoStartHandler = function buttonVideoStartHandler() {
  buttonVideoStart.addEventListener('click', function () {
